...
export default function Hero() {
  ...
  return (
    <section className="min-h-[calc(100vh-68px)] flex items-center px-6 py-16 relative" style={{ perspective: 1200 }}>
      <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-12 gap-10 items-center">
        <Tilt max={9} z={60} className="lg:col-span-7">
          ...
          <MaskLines as="h1" lines={["Get seen by", "real recruiters."]} accentIdx={1}
      ...
      <motion.div aria-hidden className="absolute bottom-8 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[3px] text-white/25"
