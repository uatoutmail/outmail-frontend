          ...
          {loading ? (
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-sm max-w-[130px] truncate">
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown
                  size={15}
                  className={`relative transition-transform duration-200 ${isLoginDropdownOpen ? "rotate-180" : ""}`}
                />
              </button>
              ...
              <AnimatePresence>
                {isLoginDropdownOpen && (
                  ...
                  >
                    ...
                    >
                      <span>
                        <span className="block font-syne font-semibold text-sm text-white">
                          I&rsquo;m a student
                        </span>
                      ...
                      <ArrowRight
                        size={15}
                        className="text-white/25 group-hover/i:text-primary group-hover/i:translate-x-0.5 transition-all"
                      />
                    </Link>
                    <Link
                      href="/tpo/login"
            ...
            <div className="flex-1 overflow-y-auto px-6 pt-6 pb-10">
              ...
              >
                {loading ? (
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 px-4 py-3 rounded-card border border-white/10 bg-white/[0.03]">
                      {user.profilePicture ? (
                        ...
                        <span className="w-8 h-8 rounded-full bg-primary/25 flex items-center justify-center">
                  ...
                  <div className="space-y-3">
                    <p className="text-[10px] uppercase tracking-[3px] text-primary mb-3">
                      Get started
                    </p>
                    <Link
                      href={`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/google`}
                    ...
                    >
                      <span>
                        <span className="block font-syne font-semibold text-white">
                          I&rsquo;m a student
                        </span>
