    ...
    <div className="relative overflow-x-clip bg-[#0a0b14]">
      ...
      <div className="relative z-10 min-h-[46vh] flex flex-col justify-center pt-16 pb-10 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-semibold tracking-tight leading-tight gradient-hero">
            Where Smart Outreach Meets Real Opportunities and Expert Mentorship.
          </h1>
          <p className="mt-5 text-white/60 font-display text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            ...
            <button
              ...
              className="text-white/80 font-display font-medium text-sm hover:text-[#b06cff] transition-colors duration-200"
            >
              Watch Demo →
            </button>
          </div>
