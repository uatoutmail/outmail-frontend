...
vi.mock('next/navigation', () => ({ useRouter: () => ({ replace: vi.fn(), push: vi.fn() }), usePathname: () => '/tpo/settings' }));
...
describe('SettingsPage — team members', () => {
  ...
  it('invites a new Co-TPO member and lets it be removed', async () => {
    ...
    await userEvent.type(screen.getByPlaceholderText(/colleague@college.ac.in/i), 'newtpo@bigu.edu');
