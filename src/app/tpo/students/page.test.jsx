...
vi.mock('next/navigation', () => ({ useRouter: () => ({ replace: vi.fn(), push: vi.fn() }), usePathname: () => '/tpo/students' }));
vi.mock('@/lib/api', () => ({ api: { get: vi.fn() } }));
vi.mock('@/context/AuthContext', () => ({ useAuth: vi.fn() }));
vi.mock('sonner', () => ({ toast: Object.assign(vi.fn(), { success: vi.fn(), error: vi.fn() }) }));

const students = [
  { id: 's1', name: 'Alice Student', branch: 'CSE', year: '3rd', emails: 20, jobs: 5, score: 95, status: 'active' },
  { id: 's2', name: 'Bob Student', branch: 'ECE', year: '2nd', emails: 5, jobs: 1, score: 40, status: 'inactive' },
];
