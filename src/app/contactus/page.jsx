...
function page() {
  return (
    <div className="min-h-screen bg-[#0a0b14] text-white">
      ...
      <section className="bg-[#0a0b14] py-16 px-4 border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs uppercase tracking-[4px] text-[#AD46FF] font-display font-medium mb-8">
            Company &amp; Legal
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/70">
                Phone:{" "}
                <a href="tel:+916375119988" className="text-[#AD46FF] hover:underline">
                  +91 63751 19988
                </a>
              </p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/70">
                <a href="mailto:admin@outmail.in" className="text-[#AD46FF] hover:underline">
                  admin@outmail.in
                </a>
              </p>
