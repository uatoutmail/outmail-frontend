...
/**
 * Preview-only control panel. Not part of any design — it exists so the
 * options for a section can be judged IN PLACE, next to the sections that will
 * surround them, rather than as thumbnails in isolation.
 */
          ...
          <div className="px-4 pb-3.5 space-y-2.5">
            {groups.map((g) => (
              <div key={g.name} className="flex items-center gap-3 flex-wrap">
                <span className="w-[112px] shrink-0 text-[10px] uppercase tracking-[1.5px] text-white/35">{g.name}</span>
            ...
            {links.length > 0 && (
              <div className="flex items-center gap-3 pt-1.5 border-t border-white/10">
                <span className="w-[112px] shrink-0 text-[10px] uppercase tracking-[1.5px] text-white/25">Pages</span>
...
export const PAGE_LINKS = [
  ...
  { href: "/design-preview/partnership", label: "Partnership" },
];
